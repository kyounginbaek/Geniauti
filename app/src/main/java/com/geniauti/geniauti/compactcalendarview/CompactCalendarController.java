package com.geniauti.geniauti.compactcalendarview;
...
import com.geniauti.geniauti.compactcalendarview.Events;
import com.geniauti.geniauti.compactcalendarview.EventsContainer;
import com.geniauti.geniauti.compactcalendarview.WeekUtils;
...
import static com.geniauti.geniauti.compactcalendarview.CompactCalendarView.CompactCalendarViewListener;
import static com.geniauti.geniauti.compactcalendarview.CompactCalendarView.FILL_LARGE_INDICATOR;
import static com.geniauti.geniauti.compactcalendarview.CompactCalendarView.NO_FILL_LARGE_INDICATOR;
import static com.geniauti.geniauti.compactcalendarview.CompactCalendarView.SMALL_INDICATOR;
...
class CompactCalendarController {
    ...
    private com.geniauti.geniauti.compactcalendarview.EventsContainer eventsContainer;
    ...
    CompactCalendarController(Paint dayPaint, OverScroller scroller, Rect textSizeRect, AttributeSet attrs,
                              ...
                              int multiEventIndicatorColor, com.geniauti.geniauti.compactcalendarview.EventsContainer eventsContainer,
    ...
    private void loadAttributes(AttributeSet attrs, Context context) {
        if (attrs != null && context != null) {
            TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, com.geniauti.geniauti.R.styleable.CompactCalendarView, 0, 0);
            try {
                currentDayBackgroundColor = typedArray.getColor(com.geniauti.geniauti.R.styleable.CompactCalendarView_compactCalendarCurrentDayBackgroundColor, currentDayBackgroundColor);
                calenderTextColor = typedArray.getColor(com.geniauti.geniauti.R.styleable.CompactCalendarView_compactCalendarTextColor, calenderTextColor);
                currentDayTextColor = typedArray.getColor(com.geniauti.geniauti.R.styleable.CompactCalendarView_compactCalendarCurrentDayTextColor, calenderTextColor);
                otherMonthDaysTextColor = typedArray.getColor(com.geniauti.geniauti.R.styleable.CompactCalendarView_compactCalendarOtherMonthDaysTextColor, otherMonthDaysTextColor);
                currentSelectedDayBackgroundColor = typedArray.getColor(com.geniauti.geniauti.R.styleable.CompactCalendarView_compactCalendarCurrentSelectedDayBackgroundColor, currentSelectedDayBackgroundColor);
                currentSelectedDayTextColor = typedArray.getColor(com.geniauti.geniauti.R.styleable.CompactCalendarView_compactCalendarCurrentSelectedDayTextColor, calenderTextColor);
                calenderBackgroundColor = typedArray.getColor(com.geniauti.geniauti.R.styleable.CompactCalendarView_compactCalendarBackgroundColor, calenderBackgroundColor);
                multiEventIndicatorColor = typedArray.getColor(com.geniauti.geniauti.R.styleable.CompactCalendarView_compactCalendarMultiEventIndicatorColor, multiEventIndicatorColor);
                textSize = typedArray.getDimensionPixelSize(com.geniauti.geniauti.R.styleable.CompactCalendarView_compactCalendarTextSize,
                        (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, textSize, context.getResources().getDisplayMetrics()));
                targetHeight = typedArray.getDimensionPixelSize(com.geniauti.geniauti.R.styleable.CompactCalendarView_compactCalendarTargetHeight,
                        (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, targetHeight, context.getResources().getDisplayMetrics()));
                eventIndicatorStyle = typedArray.getInt(com.geniauti.geniauti.R.styleable.CompactCalendarView_compactCalendarEventIndicatorStyle, SMALL_INDICATOR);
                currentDayIndicatorStyle = typedArray.getInt(com.geniauti.geniauti.R.styleable.CompactCalendarView_compactCalendarCurrentDayIndicatorStyle, FILL_LARGE_INDICATOR);
                currentSelectedDayIndicatorStyle = typedArray.getInt(com.geniauti.geniauti.R.styleable.CompactCalendarView_compactCalendarCurrentSelectedDayIndicatorStyle, FILL_LARGE_INDICATOR);
                displayOtherMonthDays = typedArray.getBoolean(com.geniauti.geniauti.R.styleable.CompactCalendarView_compactCalendarDisplayOtherMonthDays, displayOtherMonthDays);
                shouldSelectFirstDayOfMonthOnScroll = typedArray.getBoolean(com.geniauti.geniauti.R.styleable.CompactCalendarView_compactCalendarShouldSelectFirstDayOfMonthOnScroll, shouldSelectFirstDayOfMonthOnScroll);
            } finally {
                typedArray.recycle();
            }
        }
    ...
    void drawEvents(Canvas canvas, Calendar currentMonthToDrawCalender, int offset) {
        ...
        List<com.geniauti.geniauti.compactcalendarview.Events> uniqEvents = eventsContainer.getEventsForMonthAndYear(currentMonth, currentMonthToDrawCalender.get(Calendar.YEAR));
        ...
        if (uniqEvents != null) {
            for (int i = 0; i < uniqEvents.size(); i++) {
                com.geniauti.geniauti.compactcalendarview.Events events = uniqEvents.get(i);
...
//                            drawEventsWithPlus(canvas, xPosition, yPosition, eventsList);
                            drawFifthEvents(canvas, xPosition, yPosition, eventsList);
    ...
    private void drawFourEvents(Canvas canvas, float xPosition, float yPosition, List<Event> eventsList) {
        //draw fist event just left of center
        drawEventIndicatorCircle(canvas, xPosition + (xIndicatorOffset * -3), yPosition, eventsList.get(0).getColor());

        drawEventIndicatorCircle(canvas, xPosition + (xIndicatorOffset * -1), yPosition, eventsList.get(1).getColor());

        drawEventIndicatorCircle(canvas, xPosition + (xIndicatorOffset * 1), yPosition, eventsList.get(2).getColor());
        //draw second event just right of center
        drawEventIndicatorCircle(canvas, xPosition + (xIndicatorOffset * 3), yPosition, eventsList.get(3).getColor());
    }

    private void drawFifthEvents(Canvas canvas, float xPosition, float yPosition, List<Event> eventsList) {
        //draw fist event just left of center
        drawEventIndicatorCircle(canvas, xPosition + (xIndicatorOffset * -4), yPosition, eventsList.get(0).getColor());

        drawEventIndicatorCircle(canvas, xPosition + (xIndicatorOffset * -2), yPosition, eventsList.get(1).getColor());

        drawEventIndicatorCircle(canvas, xPosition + (xIndicatorOffset * 0), yPosition, eventsList.get(2).getColor());

        drawEventIndicatorCircle(canvas, xPosition + (xIndicatorOffset * 2), yPosition, eventsList.get(3).getColor());
        //draw second event just right of center
        drawEventIndicatorCircle(canvas, xPosition + (xIndicatorOffset * 4), yPosition, eventsList.get(4).getColor());
    }
