...
import com.geniauti.geniauti.compactcalendarview.comparators.EventComparator;
...
public class EventsContainer {
    ...
    private Map<String, List<com.geniauti.geniauti.compactcalendarview.Events>> eventsByMonthAndYearMap = new HashMap<>();
    ...
    void addEvent(Event event) {
        ...
        List<com.geniauti.geniauti.compactcalendarview.Events> eventsForMonth = eventsByMonthAndYearMap.get(key);
        if (eventsForMonth == null) {
            eventsForMonth = new ArrayList<>();
        }
        com.geniauti.geniauti.compactcalendarview.Events eventsForTargetDay = getEventDayEvent(event.getTimeInMillis());
        if (eventsForTargetDay == null) {
            List<Event> events = new ArrayList<>();
            events.add(event);
            eventsForMonth.add(new com.geniauti.geniauti.compactcalendarview.Events(event.getTimeInMillis(), events));
        } else {
    ...
    List<Event> getEventsFor(long epochMillis) {
        com.geniauti.geniauti.compactcalendarview.Events events = getEventDayEvent(epochMillis);
        if (events == null) {
    ...
    List<com.geniauti.geniauti.compactcalendarview.Events> getEventsForMonthAndYear(int month, int year){
    ...
    List<Event> getEventsForMonth(long eventTimeInMillis){
        ...
        List<com.geniauti.geniauti.compactcalendarview.Events> events = eventsByMonthAndYearMap.get(keyForCalendarEvent);
        List<Event> allEventsForMonth = new ArrayList<>();
        if (events != null) {
            for(com.geniauti.geniauti.compactcalendarview.Events eve : events){
                if (eve != null) {
    ...
    private com.geniauti.geniauti.compactcalendarview.Events getEventDayEvent(long eventTimeInMillis){
        eventsCalendar.setTimeInMillis(eventTimeInMillis);
        int dayInMonth = eventsCalendar.get(Calendar.DAY_OF_MONTH);
        String keyForCalendarEvent = getKeyForCalendarEvent(eventsCalendar);
        List<com.geniauti.geniauti.compactcalendarview.Events> eventsForMonthsAndYear = eventsByMonthAndYearMap.get(keyForCalendarEvent);
        if (eventsForMonthsAndYear != null) {
            for (com.geniauti.geniauti.compactcalendarview.Events events : eventsForMonthsAndYear) {
    ...
    void removeEventByEpochMillis(long epochMillis) {
        ...
        int dayInMonth = eventsCalendar.get(Calendar.DAY_OF_MONTH);
        String key = getKeyForCalendarEvent(eventsCalendar);
        List<com.geniauti.geniauti.compactcalendarview.Events> eventsForMonthAndYear = eventsByMonthAndYearMap.get(key);
        if (eventsForMonthAndYear != null) {
            Iterator<com.geniauti.geniauti.compactcalendarview.Events> calendarDayEventIterator = eventsForMonthAndYear.iterator();
            while (calendarDayEventIterator.hasNext()) {
                com.geniauti.geniauti.compactcalendarview.Events next = calendarDayEventIterator.next();
    ...
    void removeEvent(Event event) {
        ...
        List<com.geniauti.geniauti.compactcalendarview.Events> eventsForMonthAndYear = eventsByMonthAndYearMap.get(key);
        if (eventsForMonthAndYear != null) {
            Iterator<com.geniauti.geniauti.compactcalendarview.Events> eventsForMonthYrItr = eventsForMonthAndYear.iterator();
            while(eventsForMonthYrItr.hasNext()) {
                com.geniauti.geniauti.compactcalendarview.Events events = eventsForMonthYrItr.next();
